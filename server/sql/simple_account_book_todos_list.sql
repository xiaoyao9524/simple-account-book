...
--
-- Dumping data for table `todos_list`
--

LOCK TABLES `todos_list` WRITE;
/*!40000 ALTER TABLE `todos_list` DISABLE KEYS */;
INSERT INTO `todos_list` VALUES (1,'学习MySQL',0),(2,'学习React',0);
/*!40000 ALTER TABLE `todos_list` ENABLE KEYS */;
UNLOCK TABLES;
